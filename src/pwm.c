...
// HJI #include <math.h>
// HJI #include "pwm.h"
// HJI #include "stm32f10x_tim.h"
// HJI #include "utils.h"
// HJI #include "comio.h"
// HJI #include "stopwatch.h"
// HJI #include "fasttrig.h"
...
// HJI inline void UpdateCounter(tAxis channel, int value)
inline void UpdateCounter(uint8_t channel, int value)  // HJI
{
    IrqCnt[channel]++;
